...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950  disabled:opacity-50 disabled:cursor-not-allowed dark:focus-visible:ring-zinc-300",
  {
    variants: {
      variant: {
        default:
        ...
        ghost:
          "hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-50 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 dark:text-black",
        header:
